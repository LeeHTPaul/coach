...
import { StyleSheet, View, Text, TextInput, Image, TouchableOpacity, UIManager, LayoutAnimation, ActivityIndicator, Keyboard, Platform, ImageBackgroundBase } from 'react-native';
...
export default function SignInSignUpScreen({ navigation }) {
  ...
  return (
    <View style={styles.container}> 
      ...
      {isLogIn ? <View /> :
        <View style={{ flexDirection: "row", height: 30 }}><Text> Location : </Text>
